...
const SECTION = "Publishing/Sync for Artists";
...
export const publishingSyncForArtistsContent = {
  ...
  visual: {
    imageSrc: siteImage(SECTION, "Sync for Artists banner.png"),
    imageAlt:
    ...
    items: [
      {
        ...
        imageSrc: benefitImage(SECTION, "Global Exposure Opportunities"),
      ...
      },
      {
        ...
        imageSrc: benefitImage(SECTION, "Stronger Artist Branding"),
      ...
      },
      {
        ...
        imageSrc: benefitImage(SECTION, "Access to Industry Networks"),
