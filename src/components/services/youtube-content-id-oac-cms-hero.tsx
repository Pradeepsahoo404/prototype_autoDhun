...
import type { YoutubeContentIdOacCmsHeroContent } from "@/data/services/youtube-content-id-oac-cms";
...
export function YoutubeContentIdOacCmsHero({
  content,
  className
}: {
  content: YoutubeContentIdOacCmsHeroContent;
  className?: string;
}) {
