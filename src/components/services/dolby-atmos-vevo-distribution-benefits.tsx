import type { DolbyAtmosVevoDistributionBenefitsContent } from "@/data/services/dolby-atmos-vevo-distribution";
...
export function DolbyAtmosVevoDistributionBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: DolbyAtmosVevoDistributionBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="dolby-atmos-vevo-distribution-benefits-heading"
