...
/** Matches `src/app/page.tsx` home hero CTAs. */
const navActionBtn =
...
export type HeroServiceProps = {
  content: MusicDistributionHeroContent;
  className?: string;
};

/**
 * Service hero aligned with the home page hero (`page.tsx`): same heading scale,
...
export function HeroService({ content, className }: HeroServiceProps) {
  ...
  return (
    <section className={cn("relative overflow-hidden bg-black", className)}>
      {/* Match home `page.tsx` hero min-height + padding; extra spacer below `pt` lifts content off the nav without moving the CTA row vs home. */}
      <div className="mx-auto flex min-h-[44vh] w-full min-w-0 max-w-[100vw] flex-col px-3 pb-6 pt-10 text-center sm:min-h-[52vh] sm:px-4 sm:pb-7 sm:pt-12 md:min-h-[56vh] md:px-5 md:pb-8 md:pt-14 lg:min-h-[58vh] lg:px-6 lg:pb-9 lg:pt-16 xl:px-8">
        ...
        <div className="flex min-h-0 flex-1 flex-col justify-end">
          <div className="relative w-full min-w-0 max-w-none">
            ...
            {/* <p className={cn(heroLeadParagraphClass, "mt-2 sm:mt-3")}>{tagline}</p> */}
