import type { AnalyticsWorldwidePayoutsBenefitsContent } from "@/data/services/analytics-worldwide-payouts";
...
export function AnalyticsWorldwidePayoutsBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: AnalyticsWorldwidePayoutsBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="analytics-worldwide-payouts-benefits-heading"
