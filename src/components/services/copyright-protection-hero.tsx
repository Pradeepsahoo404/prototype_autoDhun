...
import type { CopyrightProtectionHeroContent } from "@/data/services/copyright-protection";
...
export function CopyrightProtectionHero({
  content,
  className
}: {
  content: CopyrightProtectionHeroContent;
  className?: string;
}) {
