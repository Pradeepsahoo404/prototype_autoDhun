import type { YoutubeContentIdOacCmsBenefitsContent } from "@/data/services/youtube-content-id-oac-cms";
...
export function YoutubeContentIdOacCmsBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: YoutubeContentIdOacCmsBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="youtube-content-id-oac-cms-benefits-heading"
