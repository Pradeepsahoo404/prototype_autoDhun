...
import type { GrowthMarketingToolsHeroContent } from "@/data/growth/marketing-tools";
...
export function GrowthMarketingToolsHero({
  content,
  className
}: {
  content: GrowthMarketingToolsHeroContent;
  className?: string;
}) {
