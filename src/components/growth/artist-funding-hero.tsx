...
import type { GrowthArtistFundingHeroContent } from "@/data/growth/artist-funding";
...
export function GrowthArtistFundingHero({
  content,
  className
}: {
  content: GrowthArtistFundingHeroContent;
  className?: string;
}) {
