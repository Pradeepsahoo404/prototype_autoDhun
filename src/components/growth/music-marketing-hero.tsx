...
import type { GrowthMusicMarketingHeroContent } from "@/data/growth/music-marketing";
...
export function GrowthMusicMarketingHero({
  content,
  className
}: {
  content: GrowthMusicMarketingHeroContent;
  className?: string;
}) {
