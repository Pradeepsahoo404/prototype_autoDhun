import type { GrowthArtistFundingBenefitsContent } from "@/data/growth/artist-funding";
...
export function GrowthArtistFundingBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: GrowthArtistFundingBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="growth-artist-funding-benefits-heading"
