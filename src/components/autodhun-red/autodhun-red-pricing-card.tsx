...
export function AutodhunRedPricingCard({
  plan,
  className
}: {
  plan: AutodhunRedPlanDto;
  className?: string;
}) {
  return (
    <div className={cn("relative mx-auto h-full w-full max-w-[400px]", className)}>
      <div
        className={cn(
          "h-full rounded-[24px] p-px",
          "bg-gradient-to-br from-[#ff5a5f] via-[#e8222a] to-[#7a1015]",
          "shadow-[0_20px_60px_rgba(0,0,0,0.65),0_0_40px_rgba(232,34,42,0.08)]"
        )}
      >
        <article className="relative flex h-full min-h-0 flex-col overflow-hidden rounded-[23px] bg-[#050505]">
          <div
            aria-hidden
          ...
          <div className="flex flex-1 flex-col px-7 pb-8 pt-8 sm:px-8 sm:pb-9 sm:pt-9">
            ...
            <div className="mt-auto border-t border-white/[0.1] pt-7">
