import type { ForDistributionPartnersBenefitsContent } from "@/data/solutions/for-distribution-partners";
...
export function ForDistributionPartnersBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: ForDistributionPartnersBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="for-distribution-partners-benefits-heading"
