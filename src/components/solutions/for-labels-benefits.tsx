import type { ForLabelsBenefitsContent } from "@/data/solutions/for-labels";
...
export function ForLabelsBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: ForLabelsBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="for-labels-benefits-heading"
