...
import type { ForDistributionPartnersHeroContent } from "@/data/solutions/for-distribution-partners";
...
export function ForDistributionPartnersHero({
  content,
  className
}: {
  content: ForDistributionPartnersHeroContent;
  className?: string;
}) {
