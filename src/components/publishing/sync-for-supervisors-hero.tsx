...
import type { PublishingSyncForSupervisorsHeroContent } from "@/data/publishing/sync-for-supervisors";
...
export function PublishingSyncForSupervisorsHero({
  content,
  className
}: {
  content: PublishingSyncForSupervisorsHeroContent;
  className?: string;
}) {
  const { kicker, titleLine1, titleLine2, subtitle, primaryCta } = content;
