...
import type { PublishingAdministrationHeroContent } from "@/data/publishing/publishing-administration";
...
export function PublishingAdministrationHero({
  content,
  className
}: {
  content: PublishingAdministrationHeroContent;
  className?: string;
}) {
