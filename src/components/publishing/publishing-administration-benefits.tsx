import type { PublishingAdministrationBenefitsContent } from "@/data/publishing/publishing-administration";
...
export function PublishingAdministrationBenefitsSection({
  content,
  className,
  hideTopRule = false
}: {
  content: PublishingAdministrationBenefitsContent;
  className?: string;
  hideTopRule?: boolean;
}) {
  ...
  return (
    ...
    >
      ...
      <div className="faq-container relative z-[1]">
        <FadeUp>
          <ServiceBenefitsSectionHeader
            headingId="publishing-administration-benefits-heading"
