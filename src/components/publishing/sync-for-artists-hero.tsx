...
import type { PublishingSyncForArtistsHeroContent } from "@/data/publishing/sync-for-artists";
...
export function PublishingSyncForArtistsHero({
  content,
  className
}: {
  content: PublishingSyncForArtistsHeroContent;
  className?: string;
}) {
